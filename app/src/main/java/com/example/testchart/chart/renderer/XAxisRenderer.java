...
import com.example.testchart.chart.utils.FSize;
...
public class XAxisRenderer extends AxisRenderer {
    private static final String TAG = "XAxisRenderer";

    private final XAxis mXAxis;

    public XAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis, Transformer trans) {
        super(viewPortHandler, trans, xAxis);
        Log.d(TAG, "XAxisRenderer: ");
     ...
     * @param pos
     */
    private void drawLabels(Canvas c, float pos, MPPointF anchor) {
    ...
    private float[] mRenderGridLinesBuffer = new float[2];
    @Override
     ...
     * @param gridLinePath
     */
    private void drawGridLine(Canvas c, float x, float y, Path gridLinePath) {
    ...
    private final float[] mLimitLineSegmentsBuffer = new float[4];
    private final Path mLimitLinePath = new Path();

    private void renderLimitLineLine(Canvas c, LimitLine limitLine, float[] position) {
    ...
    private void renderLimitLineLabel(Canvas c, LimitLine limitLine, float[] position, float yOffset) {
