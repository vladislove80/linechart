...
public abstract class Utils {
     ...
     * @return
     */
    private static String formatNumber(float number, int digitCount, boolean separateThousands,
                                       char separateChar) {
    ...
    private static void getPosition(MPPointF center, float dist, float angle, MPPointF outputPoint){
    ...
    private static void drawMultilineText(Canvas c, StaticLayout textLayout,
                                          float x, float y,
                                          TextPaint paint,
                                          MPPointF anchor, float angleDegrees) {
