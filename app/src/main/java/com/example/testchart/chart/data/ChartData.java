...
import com.example.testchart.chart.components.YAxis.AxisDependency;
...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
     ...
     * @return
     */
    private int getDataSetIndexByLabel(List<T> dataSets, String label,
                                       boolean ignorecase) {
     ...
     * @param d
     */
    private boolean removeDataSet(T d) {
     ...
     * @param axis
     */
    private void calcMinMax(Entry e, AxisDependency axis) {
     ...
     * @param dataSetIndex
     */
    private boolean removeEntry(Entry e, int dataSetIndex) {
