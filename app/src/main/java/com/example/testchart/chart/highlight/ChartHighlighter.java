package com.example.testchart.chart.highlight;
...
public class ChartHighlighter<T extends BaseLineDataProvider> implements IHighlighter {
    private static final String TAG = "ChartHighlighter";
     ...
     */
    private final List<Highlight> mHighlightBuffer = new ArrayList<>();

    public ChartHighlighter(T chart) {
        this.mChart = chart;
        Log.d(TAG, "ChartHighlighter: ");
    }
     ...
     * @return
     */
    private MPPointD getValsForTouch(float x, float y) {
     ...
     * @return
     */
    private Highlight getHighlightForX(float xVal, float x, float y) {
     ...
     * @return
     */
    private float getMinimumDistance(List<Highlight> closestValues, float pos, YAxis.AxisDependency axis) {
    ...
    private float getHighlightPos(Highlight h) {
        return h.getYPx();
    }
     ...
     * @return
     */
    private List<Highlight> getHighlightsAtXValue(float xVal, float x, float y) {

        mHighlightBuffer.clear();

        BaseLineData data = getData();
     ...
     * @return
     */
    private List<Highlight> buildHighlights(IDataSet set, int dataSetIndex, float xVal, DataSet.Rounding rounding) {
     ...
     * @return
     */
    private Highlight getClosestHighlightByPixel(List<Highlight> closestValues, float x, float y,
