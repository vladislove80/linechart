...
import com.example.testchart.chart.formatter.DefaultAxisValueFormatter;
...
public abstract class AxisBase extends ComponentBase {
    private static final String TAG = "AxisBase";
     ...
     */
    private boolean mGranularityEnabled = false;
     ...
     */
    private boolean mDrawAxisLine = true;
    ...
    private boolean mCenterAxisLabels = false;
     ...
     */
    private boolean mDrawLimitLineBehindData = false;

    /**
     * flag indicating the grid lines layer depth
     */
    private boolean mDrawGridLinesBehindData = true;

    /**
     * Extra spacing for `axisMinimum` to be added to automatically calculated `axisMinimum`
     */
    private float mSpaceMin = 0.f;

    /**
     * Extra spacing for `axisMaximum` to be added to automatically calculated `axisMaximum`
     */
    private float mSpaceMax = 0.f;
    ...
    /**
     * Returns true if forcing the y-label count is enabled. Default: false
     *
     * @return
     */
