package com.example.testchart.chart.utils;
...
public class ViewPortHandler {
    private static final String TAG = "ViewPortHandler";

    /**
     * matrix used for touch events
     */
    final Matrix mMatrixTouch = new Matrix();
    ...
    private void zoom(float scaleX, float scaleY, Matrix outputMatrix) {
        outputMatrix.reset();
        outputMatrix.set(mMatrixTouch);
    ...
    private void setZoom(float scaleX, float scaleY, Matrix outputMatrix) {
        outputMatrix.reset();
        outputMatrix.set(mMatrixTouch);
    ...
    private final float[] valsBufferForFitScreen = new float[9];
     ...
     */
    private void fitScreen(Matrix outputMatrix) {
        mMinScaleX = 1f;
        mMinScaleY = 1f;
     ...
     * @return
     */
    private void translate(final float[] transformedPts, Matrix outputMatrix) {
        outputMatrix.reset();
        outputMatrix.set(mMatrixTouch);
    ...
    private final Matrix mCenterViewPortMatrixBuffer = new Matrix();
