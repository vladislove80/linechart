 ...
 *
 */
public class LineChartTouchListener extends ChartTouchListener<LineChartBase<? extends BaseLineData<?
        extends ILineDataSet<? extends Entry>>>> {
     ...
     */
    public LineChartTouchListener(LineChartBase<? extends BaseLineData<? extends
            ILineDataSet<? extends Entry>>> chart, Matrix touchMatrix, float dragTriggerDistance) {
        super(chart);
        Log.d(TAG, "LineChartTouchListener: ");
     ...
     * @return
     */
    private MPPointF getTrans(float x, float y) {
